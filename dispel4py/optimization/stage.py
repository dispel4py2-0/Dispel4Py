...
def check_grouping(obj):
    if "grouping" in list(obj.inputconnections.values())[0]:
        return True
    else:
        return False
...
def map_partitions(graph):
    ...
    for obj in source_pe_dict.keys():
