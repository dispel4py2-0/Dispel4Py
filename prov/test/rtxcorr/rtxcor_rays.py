...
def createGraphWithProv():
    ...
    InitiateNewRun(graph,ProvenanceRecorderToFile,provImpClass=ProvenancePE,username='xxx',runId=rid,w3c_prov=False,workflowName="test_rdwd",workflowId="xx",clustersRecorders=clustersRecorders,feedbackPEs=['google','facebook'])
